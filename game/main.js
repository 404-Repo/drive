...
import { detectTier, getTier, applyTierToRenderer } from './src/render/quality.js?v=r5-20260906181225';
import { preloadMaterials, applyRoadMaterial, applyTerrainMaterial } from './src/render/materials.js?v=r5-20260906181225';
import { createSky } from './src/render/sky.js?v=r5-20260906181225';
import { createLightingRig } from './src/render/lighting.js?v=r5-20260906181225';
import { createPost } from './src/render/post.js?v=r5-20260906181225';
import { SPLINE, START_PROGRESS, CHECKPOINTS, LAP_LENGTH } from './src/track/spline.js?v=r5-20260906181225';
import { buildRoad } from './src/track/road.js?v=r5-20260906181225';
import { buildTerrain } from './src/track/terrain.js?v=r5-20260906181225';
import { buildSea } from './src/track/sea.js?v=r5-20260906181225';
import { World } from './src/track/collision.js?v=r5-20260906181225';
import { buildLevel } from './src/level/build.js?v=r5-20260906181225';
import { GRID, PLACEMENTS } from './src/level/placements.js?v=r5-20260906181225';
import { KartBody, resolveBumps } from './src/kart/physics.js?v=r5-20260906181225';
import { Player } from './src/kart/player.js?v=r5-20260906181225';
import { KartView } from './src/kart/kartview.js?v=r5-20260906181225';
import { ChaseCamera } from './src/kart/camera.js?v=r5-20260906181225';
import { AIRacer, PERSONALITIES } from './src/ai/racer.js?v=r5-20260906181225';
import { Director } from './src/ai/director.js?v=r5-20260906181225';
import { DriftSmoke } from './src/ai/driftfx.js?v=r5-20260906181225';
import { ItemSystem } from './src/items/items.js?v=r5-20260906181225';
import { Screens } from './src/ui/screens.js?v=r5-20260906181225';
import { HUD } from './src/ui/hud.js?v=r5-20260906181225';
import { Minimap } from './src/ui/minimap.js?v=r5-20260906181225';
import { Input } from './src/ui/input.js?v=r5-20260906181225';
import { TouchControls } from './src/ui/touch.js?v=r5-20260906181225';
import { Audio } from './src/audio/audio.js?v=r5-20260906181225';
import { Events } from './src/game/events.js?v=r5-20260906181225';
import { Race } from './src/game/race.js?v=r5-20260906181225';
import { createTelemetry } from './src/game/telemetry.js?v=r5-20260906181225';
