...
import { detectTier, getTier, applyTierToRenderer } from './src/render/quality.js?v=r4-20260906171652';
import { preloadMaterials, applyRoadMaterial, applyTerrainMaterial } from './src/render/materials.js?v=r4-20260906171652';
import { createSky } from './src/render/sky.js?v=r4-20260906171652';
import { createLightingRig } from './src/render/lighting.js?v=r4-20260906171652';
import { createPost } from './src/render/post.js?v=r4-20260906171652';
import { SPLINE, START_PROGRESS, CHECKPOINTS, LAP_LENGTH } from './src/track/spline.js?v=r4-20260906171652';
import { buildRoad } from './src/track/road.js?v=r4-20260906171652';
import { buildTerrain } from './src/track/terrain.js?v=r4-20260906171652';
import { buildSea } from './src/track/sea.js?v=r4-20260906171652';
import { World } from './src/track/collision.js?v=r4-20260906171652';
import { buildLevel } from './src/level/build.js?v=r4-20260906171652';
import { GRID, PLACEMENTS } from './src/level/placements.js?v=r4-20260906171652';
import { KartBody, resolveBumps } from './src/kart/physics.js?v=r4-20260906171652';
import { Player } from './src/kart/player.js?v=r4-20260906171652';
import { KartView } from './src/kart/kartview.js?v=r4-20260906171652';
import { ChaseCamera } from './src/kart/camera.js?v=r4-20260906171652';
import { AIRacer, PERSONALITIES } from './src/ai/racer.js?v=r4-20260906171652';
import { Director } from './src/ai/director.js?v=r4-20260906171652';
import { DriftSmoke } from './src/ai/driftfx.js?v=r4-20260906171652';
import { ItemSystem } from './src/items/items.js?v=r4-20260906171652';
import { Screens } from './src/ui/screens.js?v=r4-20260906171652';
import { HUD } from './src/ui/hud.js?v=r4-20260906171652';
import { Minimap } from './src/ui/minimap.js?v=r4-20260906171652';
import { Input } from './src/ui/input.js?v=r4-20260906171652';
import { TouchControls } from './src/ui/touch.js?v=r4-20260906171652';
import { Audio } from './src/audio/audio.js?v=r4-20260906171652';
import { Events } from './src/game/events.js?v=r4-20260906171652';
import { Race } from './src/game/race.js?v=r4-20260906171652';
import { createTelemetry } from './src/game/telemetry.js?v=r4-20260906171652';

const Q = new URLSearchParams(location.search);
const STAMP = window.__BUILD_STAMP__ || null;
const ROUND = STAMP && /^r\d+/.test(STAMP) ? STAMP.match(/^r\d+/)[0] : 'r4';
